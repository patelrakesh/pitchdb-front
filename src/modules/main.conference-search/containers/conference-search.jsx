...
import ConferenceSearchPanel from '../components/conference-search-panel';
import update from 'immutability-helper';

class ConferenceSearch extends React.Component {
  constructor (props) {
    super(props);
    this.state = {
      searchResults: null,
  ...
  render = () => <ConferenceSearchPanel {...this.props} {...this.state} {...this.functions} />
